...
<body>
      ...
      <div class="row">
        <div class="col-md-6 d-flex align-items-center">
          <p class="mb-0 phone pl-md-2">
            <a href="#" class="mr-2"><span class="fa fa-phone mr-1"></span> poner numers</a>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.php"><span class="flaticon-pawprint-1 mr-2"></span>Estética Canina</a>
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
        ...
        <div class="col-md-11 ftco-animate text-center">
          <h1 class="mb-4">Más que un servicio, un lugar donde tu mascota se siente en casa. </h1>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row services-row">
        ...
        <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
          <div class="d-block services text-center">
            ...
            <div class="media-body">
              <h3 class="heading">Veterinaria</h3>
              <p>Consultas médicas, vacunas y atención profesional para la salud de tu mascota.</p>
        ...
        <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
          <div class="d-block services text-center">
            ...
            <div class="media-body">
              <h3 class="heading">Guardería</h3>
              <p>Un espacio seguro y divertido donde tu mascota estará cuidada mientras no estás.</p>
              <a href="#" class="btn-custom d-flex align-items-center justify-content-center">
                <span class="fa fa-chevron-right"></span><i class="sr-only">Leer más</i>
              </a>
            </div>
        ...
        <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
          <div class="d-block services text-center">
            ...
            <div class="media-body">
              ...
              <p>Hospedaje cómodo y confiable con atención personalizada para cada peludito.</p>
              <a href="#" class="btn-custom d-flex align-items-center justify-content-center">
                <span class="fa fa-chevron-right"></span><i class="sr-only">Leer más</i>
              </a>
            </div>
        ...
        <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
          <div class="d-block services text-center">
            ...
            <div class="media-body">
              ...
              <p>Terapias relajantes, masajes y cuidados especiales para consentir a tu mascota.</p>
              <a href="#" class="btn-custom d-flex align-items-center justify-content-center">
                <span class="fa fa-chevron-right"></span><i class="sr-only">Leer más</i>
              </a>
            </div>
